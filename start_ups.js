...
function creativityGen() {

    var randomName = thisArray[Math.floor(Math.random() * thisArray.length)];
    var randomBusiness = thatArray[Math.floor(Math.random() * thatArray.length)];
    var randomAmount = Math.floor((Math.random() * 18) + 1);

    console.log("Can I have $" + randomAmount + " million to start my business in " + randomBusiness + "? I'll call it " + randomName + "!");
